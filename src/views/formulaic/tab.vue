<template>
  <div class="container">
    <div class="pane">
      <label class="label" v-for="{ tab, key } in config" @click="handleTabChange(key)">
        <span>{{ tab }}</span>
        <input id="left" class="input" name="radio" type="radio" :checked="tabActive === key" />
      </label>
