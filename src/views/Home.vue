<template>
  <div class="header">
    <button class="button" data-text="Awesome">
      <span class="actual-text">&nbsp;Frontend&nbsp;ACE&nbsp;</span>
      <span aria-hidden="true" class="hover-text">&nbsp;Frontend&nbsp;ACE&nbsp;</span>
    </button>
  </div>

  <div class="container">
    <div data-text="八股文" style="--r: -15" class="glass" @click="router.push('/formulaic')">
    ...
    <div data-text="算法刷题" style="--r: 5" class="glass" @click="router.push('/compute')">
    ...
    <div data-text="面试技巧" style="--r: 25" class="glass">
...
.container .glass:hover {
  background: linear-gradient(rgba(232, 223, 127, 0.13), transparent);
}
